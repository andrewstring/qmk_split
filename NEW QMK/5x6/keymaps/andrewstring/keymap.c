...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_GAMING] = LAYOUT_5x6(
        TO(0), KC_A, KC_B, KC_C, KC_D, KC_E,         KC_E, KC_D, KC_C, KC_B, KC_A, KC_4,
        KC_F, KC_G, KC_H, KC_UP, KC_J, KC_K,         KC_K, KC_J, KC_I, KC_H, KC_G, KC_F,
        KC_L, KC_M, KC_LEFT, KC_DOWN, KC_RIGHT, KC_Q,         KC_Q, KC_P, KC_O, KC_N, KC_M, KC_L,
        KC_R, KC_S, KC_T, KC_U, KC_V, KC_W,         KC_W, KC_V, KC_U, KC_T, KC_S, KC_R,
                       KC_X, KC_Y, KC_Z,               KC_Z, KC_Y, KC_X,
                  KC_SPACE, KC_ESCAPE, KC_ENTER, KC_3,            KC_3, KC_2, KC_1, KC_0
    ),
